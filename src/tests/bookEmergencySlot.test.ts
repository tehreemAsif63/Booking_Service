...
describe("bookEmergencySlot", () => {
  it("should throw slot not found for update", async () => {
    ...
    await expect(bookEmergencySlot(mockSlot, requestInfo)).rejects.toThrow(
